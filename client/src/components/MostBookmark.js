    ...
    <>
      <Container>
        <Row>
          {data.map((item, index) => (
            <>
              <Col key={item.journey.id} id={item.journey.id} >
                  ...
                  <Card.Body id="bodyCard" >
                    {state.isLogin == true &&
                      <>
                        {item.bookmark === true
                          ...
                          :
                          <div class="card-img-overlay" id="wrapBookmarkStyle" onClick={() => handleAddBookmark(item.journey.id)}>
                    ...
                    <Card.Title id="cardTitle" >
                      ...
                      <ExpendableText maxHeight={85} id="descriptionCardList">
                        {striptags(draftToHtml(JSON.parse(item.journey.description)))}
